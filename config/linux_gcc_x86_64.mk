...
CPPFLAGS+=-fomit-frame-pointer -falign-functions=32 -falign-jumps=32 -falign-labels=32 -falign-loops=32 \
	  ...
	  -DFD_HAS_INT128=1 -DFD_HAS_DOUBLE=1 -DFD_HAS_ALLOCA=1 -DFD_HAS_X86=1 -DFD_HAS_SSE=1 -DFD_HAS_AVX=1 -DFD_ED25519_VERIFY_USE_2POINT=1
LDFLAGS+=-lnuma
...
FD_HAS_SSE:=1
FD_HAS_AVX:=1
FD_ED25519_VERIFY_USE_2POINT:=1
